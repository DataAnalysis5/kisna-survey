  ...
  try {
    ...
    responses.forEach((response) => {
      const baseData = {
        ...
        "Based at": response.basedAt || "NA",
        "Mobile No": response.mobileNo || "NA",
...
app.post("/api/responses", async (req, res) => {
  try {
    ...
    const { surveyId, userId, department, designation, answers, name, employeeCode, basedAt, mobileNo } = req.body
